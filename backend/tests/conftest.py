...
def seed_test_data():
    ...
    c1 = Company(
        id=1,
        company_name="PRAN FMCG Corp",
        corporate_account_number="CORP-PRAN-101",
    ...
    c2 = Company(
        ...
        corporate_account_number="CORP-APEX-102",
        central_wallet_balance=3000000.00,
        status="ACTIVE",
    )
    ...
    ba1 = CompanyBankAccount(
        id=1,
        company_id=1,
        bank_name="United Commercial Bank (UCB)",
        branch_name="Gulshan",
        account_name="PRAN Payout",
        account_number="09511010001",
    ...
    ba2 = CompanyBankAccount(
        ...
        account_name="Apex Payout",
        account_number="11018899221",
    ...
    u_checker = User(
        id=2,
        company_id=1,
        full_name="Dipra Checker",
        email="checker1@pran.com",
    ...
    u_maker2 = User(
        id=3,
        company_id=2,
        full_name="Rahim Maker",
        email="maker2@apex.com",
    ...
    accs = [
        Account(
            phone_number="01711112233", account_holder_name="Karim Rahman", account_status="ACTIVE"
        ),
        Account(
            phone_number="01722223344", account_holder_name="Nasrin Akter", account_status="ACTIVE"
        ),
        Account(
            phone_number="01733334455", account_holder_name="Sujon Islam", account_status="ACTIVE"
        ),
        Account(
            phone_number="01755556677",
            account_holder_name="Inactive Mobile",
