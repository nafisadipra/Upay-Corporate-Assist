...
def seed_database():
    ...
    c1 = Company(
        ...
        corporate_account_number="UPAY-CORP-FMCG-1001",
        central_wallet_balance=5000000.00,
        status="ACTIVE",
    )
    c2 = Company(
        id=2,
        company_name="Investment Management Firm (UCB Alignment)",
        corporate_account_number="UPAY-CORP-INVST-1002",
        central_wallet_balance=12000000.00,
        status="ACTIVE",
    )
    ...
    ba1 = CompanyBankAccount(
        id=1,
        company_id=1,
        bank_name="United Commercial Bank PLC (UCB)",
        branch_name="Corporate Head Office Branch, Dhaka",
        account_name="PRAN-RFL FMCG Corporate Payout A/C",
        account_number="0951101000012345",
        routing_number="245260951",
        account_type="CURRENT",
        status="ACTIVE",
        is_primary=True,
    )
    ba2 = CompanyBankAccount(
        id=2,
        company_id=1,
        bank_name="City Bank PLC",
        branch_name="Gulshan Avenue Branch",
        account_name="PRAN FMCG Operational Float",
        account_number="1101889922001",
        routing_number="225271101",
        account_type="SETTLEMENT",
        status="ACTIVE",
        is_primary=False,
    )
    ba3 = CompanyBankAccount(
        id=3,
        company_id=2,
        bank_name="United Commercial Bank PLC (UCB)",
        branch_name="Principal Branch, Motijheel",
        account_name="UCB Capital Investment Escrow",
        account_number="0951101000099887",
        routing_number="245260951",
        account_type="CURRENT",
        status="ACTIVE",
        is_primary=True,
    ...
    w1 = CentralWallet(
        ...
        account_number="CW-FMCG-PAYROLL-01",
        balance=4500000.00,
        wallet_type="MAIN",
    )
    w2 = CentralWallet(
        ...
        account_number="CW-FMCG-BONUS-02",
        balance=500000.00,
    ...
    w3 = CentralWallet(
        id=3,
        company_id=2,
        wallet_name="Corporate Disbursement Wallet",
        account_number="CW-INVST-MAIN-01",
        balance=12000000.00,
        wallet_type="MAIN",
    )
    ...
    u1 = User(
        ...
        email="maker.tanvir@fmcg-corp.com",
    ...
    u2 = User(
        ...
        email="checker.dipra@fmcg-corp.com",
    ...
    u3 = User(
        ...
        email="maker.rahim@invest-corp.com",
    ...
    accs = [
        Account(
            ...
            account_holder_name="Kazi Anisur Rahman",
            account_status="ACTIVE",
        ),
        Account(
            phone_number="01722223344", account_holder_name="Sultana Razia", account_status="ACTIVE"
        ),
        Account(
            phone_number="01733334455", account_holder_name="Mohammad Ali", account_status="ACTIVE"
        ),
        Account(
            phone_number="01744445566",
            account_holder_name="Rahul Roy (New Hire)",
            account_status="ACTIVE",
        ),
        Account(
            phone_number="01755556677",
            account_holder_name="Imtiaz Hossain",
            account_status="INACTIVE",
        ),
        Account(
            phone_number="01811112233",
            account_holder_name="Mahmudul Hasan",
            account_status="ACTIVE",
        ),
        Account(
            phone_number="01822223344", account_holder_name="Nusrat Jahan", account_status="ACTIVE"
        ),
        Account(
            phone_number="01833334455",
            account_holder_name="External Individual (Abdur Rashid)",
            account_status="ACTIVE",
        ),
    ]
    ...
    emps = [
        Employee(
            ...
            phone_number="01711112233",
            employee_name="Kazi Anisur Rahman",
        ...
        Employee(
            ...
            phone_number="01722223344",
            employee_name="Sultana Razia",
            department="Accounts",
        ...
        Employee(
            ...
            phone_number="01733334455",
            employee_name="Mohammad Ali",
        ...
        Employee(
            ...
            phone_number="01744445566",
            employee_name="Rahul Roy (New Hire)",
            department="Engineering",
    ...
    for d in dates:
        hist.append(
            PayrollHistory(
                ...
                six_month_avg_amount=35000.00,
                dept_avg_amount=38000.00,
            )
        )
        hist.append(
            PayrollHistory(
                ...
                department="Accounts",
                disbursement_date=d,
                basic_salary=25200.00,
                gross_salary=42000.00,
                six_month_avg_amount=42000.00,
                dept_avg_amount=45000.00,
            )
        )
    ...
    b1 = Batch(
        ...
        maker_id=1,
        checker_id=2,
        file_name="FMCG_Payroll_August_2026.xlsx",
        total_records=6,
        valid_records=3,
        invalid_records=3,
        flagged_anomalies=3,
        total_amount=498000.00,
        status="FLAGGED_RISK",
    )
    db.session.add(b1)
    db.session.commit()
    ...
    items = [
        ...
        BatchItem(
            ...
            is_anomaly=True,
            anomaly_reason="Unusual Variance: 300,000 BDT deviates significantly from 6-month individual avg (42,000 BDT)",
            item_status="PENDING",
        ),
        BatchItem(
            id=3,
            batch_id=1,
            employee_id=None,
            raw_phone_number="01833334455",
            employee_name="Abdur Rashid",
            department="External",
            basic_salary=15000.00,
            gross_salary=25000.00,
            account_validation_status="UNRECOGNIZED_PAYEE",
            baseline_status="VERIFIED",
            anomaly_score=-0.4500,
            is_anomaly=True,
            anomaly_reason="Roster Mismatch: Active upay phone number is absent from corporate HR roster",
            item_status="PENDING",
        ),
        BatchItem(
            id=4,
            ...
            employee_name="New Worker",
            department="Factory",
            basic_salary=22200.00,
            gross_salary=37000.00,
            account_validation_status="UNREGISTERED_ACCOUNT",
            baseline_status="VERIFIED",
            is_anomaly=False,
            anomaly_reason="Account does not exist on upay MFS platform",
            item_status="PENDING",
        ),
        BatchItem(
            id=5,
            batch_id=1,
            employee_id=4,
            raw_phone_number="01755556677",
            employee_name="Imtiaz Hossain",
            department="Logistics",
            basic_salary=21000.00,
            gross_salary=35000.00,
            account_validation_status="INACTIVE_ACCOUNT",
            baseline_status="VERIFIED",
            is_anomaly=False,
            anomaly_reason="Account is currently suspended/inactive",
            item_status="PENDING",
        ),
        BatchItem(
            id=6,
            ...
            is_anomaly=True,
            anomaly_reason="Baseline Pending: New employee (<3 cycles). Flagged against Engineering Dept avg (38,000 BDT)",
            item_status="PENDING",
        ),
    ]
    ...
    alerts = [
        RiskAlert(
            ...
            review_notes="Requires Finance Director sign-off due to high bonus payout amount.",
        ),
        RiskAlert(
            id=2,
            batch_item_id=3,
            ...
            severity="CRITICAL",
            review_status="PENDING_REVIEW",
            review_notes="Ghost employee prevention: payee phone number is absent from corporate HR roster.",
        ),
        RiskAlert(
            id=3,
            batch_item_id=6,
            ...
            severity="MEDIUM",
            review_status="PENDING_REVIEW",
            review_notes="First-cycle payout baseline pending comparison against department average.",
        ),
    ]
    db.session.add_all(alerts)

    # 11. Liquidity Forecasts
    f1 = LiquidityForecast(
        company_id=1,
        forecast_period="SEPTEMBER_2026",
        predicted_amount=5200000.00,
        confidence_score=0.96,
    )
    f2 = LiquidityForecast(
        company_id=1,
        forecast_period="OCTOBER_2026",
        predicted_amount=4850000.00,
    ...
    a2 = AuditLog(
        ...
        user_id=1,
        audit_scope="CORPORATE_CLIENT",
        action="CORE_ACCOUNT_VERIFICATION",
        details={"valid_records": 3, "invalid_records": 3},
    )
    a3 = AuditLog(
        company_id=1,
        batch_id=1,
        user_id=1,
        audit_scope="CORPORATE_CLIENT",
        action="AI_RISK_SCREENING_COMPLETED",
        details={"algorithm": "IsolationForest", "flagged_anomalies": 3},
    )
    a4 = AuditLog(
        company_id=1,
        user_id=4,
        ...
        details={"company_name": "Leading FMCG Conglomerate", "opening_balance": 5000000.00},
    )
    a5 = AuditLog(
        company_id=1,
        user_id=4,
